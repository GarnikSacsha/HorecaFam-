...
This directory contains only the CRA-20 API foundation. Python 3.12 and PostgreSQL 16 are the approved runtime versions.
...
The application is exposed through the factory `app.main:create_app`; configuration is required and there is no SQLite fallback.
...
The complete no-skip gate and accepted CRA-20 evidence are documented in
